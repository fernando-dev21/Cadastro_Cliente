...
const result = await db.insertUsuario({nome: "Zé", senha: "shiduhsaud332"});
console.log(result);
...
const result2 = await db.updateUsuario(3, {nome: "Zé José", senha: "ahsuahsuisdbvc7421"});
console.log(result2);
})();
